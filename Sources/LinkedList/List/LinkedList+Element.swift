...
extension LinkedList {
    ...
    /// - Parameter element: The element to pushBack
    @inlinable
    ...
    /// - Parameter collection: collection of objects to add to the list
    ...
    ///   - atIndex: The index of the insertion
    ...
    ///                 and returns a Bool value indicating if the element should be
